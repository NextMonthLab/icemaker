...
const newsPersona = {
  ...
  description: "News organizations use StoryFlix to bring complex stories to life with AI-generated visuals, character perspectives, and serialized daily drops.",
  icon: Newspaper,
  ...
  testimonial: {
    quote: "StoryFlix helped us increase daily reader retention by 3x. Our investigative series now feels like must-watch content.",
    author: "Sarah Chen",
