...
const influencerPersona = {
  ...
  description: "Creators use StoryFlix to build deeper connections through immersive narratives, daily content drops, and interactive AI characters.",
  icon: Star,
  ...
  testimonial: {
    quote: "My audience went from watching one video to checking in daily for the next story drop. StoryFlix helped me build a real community.",
    author: "Alex Rivera",
