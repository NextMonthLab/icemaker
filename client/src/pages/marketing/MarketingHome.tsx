    ...
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="max-w-7xl mx-auto px-6 py-5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/login?signup=true">
              <Button className="bg-gradient-to-r from-rose-500 to-orange-500 hover:from-rose-400 hover:to-orange-400 text-white border-0 shadow-lg shadow-orange-500/20" data-testid="button-signup">
                Get Started
              </Button>
            </Link>
          </div>
      ...
      <main>
        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
          ...
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-orange-950/15 via-transparent to-transparent" />
          ...
          <div className="max-w-5xl mx-auto px-6 text-center relative z-10 pt-20">
            ...
            >
              ...
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-display font-black tracking-tight mb-8 leading-[0.9]" data-testid="text-hero-title">
                ...
                <span className="block bg-gradient-to-r from-rose-400 to-orange-500 bg-clip-text text-transparent">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/login?signup=true">
                  <Button size="lg" className="h-14 px-8 text-lg bg-gradient-to-r from-rose-500 to-orange-500 hover:from-rose-400 hover:to-orange-400 text-white border-0 shadow-lg shadow-orange-500/20 gap-3" data-testid="button-hero-cta">
                    Create a NextScene
              ...
              <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-xl">
                <div className="aspect-video bg-neutral-900 flex items-center justify-center">
                  <div className="text-center">
                    <div className="w-20 h-20 rounded-full bg-gradient-to-br from-rose-500 to-orange-500 flex items-center justify-center mx-auto mb-4 shadow-lg shadow-orange-500/20 cursor-pointer hover:from-rose-400 hover:to-orange-400 transition-all">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-bold mb-4" data-testid="text-pipeline-title">
                What is <span className="bg-gradient-to-r from-rose-400 to-orange-500 bg-clip-text text-transparent">NextScene?</span>
              </h2>
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-bold mb-4" data-testid="text-usecases-title">
                Three ways to use <span className="bg-gradient-to-r from-rose-400 to-orange-500 bg-clip-text text-transparent">NextScene</span>
              </h2>
              <p className="text-white/50 text-lg max-w-xl mx-auto">
              ...
              {useCases.map((useCase, index) => (
                ...
                >
                  <Link href={useCase.href}>
                    <div 
                      className="group p-8 rounded-2xl bg-gradient-to-b from-white/5 to-transparent border border-white/10 hover:border-orange-500/50 cursor-pointer transition-all duration-300 hover:bg-white/5 h-full"
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 text-orange-400 text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity">
          ...
          <div className="max-w-5xl mx-auto relative z-10">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-bold mb-4" data-testid="text-different-title">
                Why NextScene is <span className="bg-gradient-to-r from-rose-400 to-orange-500 bg-clip-text text-transparent">different</span>
              </h2>
            </div>
              ...
              {differentiators.map((diff, index) => (
                ...
                >
                  <div className="w-10 h-10 rounded-lg bg-orange-500/20 flex items-center justify-center flex-shrink-0">
                    <diff.icon className="w-5 h-5 text-orange-400" />
                  </div>
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            >
              <h2 className="text-4xl md:text-6xl font-display font-bold mb-6" data-testid="text-cta-title">
                ...
                <span className="bg-gradient-to-r from-rose-400 to-orange-500 bg-clip-text text-transparent">NextScene?</span>
              </h2>
              ...
              <Link href="/login?signup=true">
                <Button size="lg" className="h-16 px-12 text-lg bg-gradient-to-r from-rose-500 to-orange-500 hover:from-rose-400 hover:to-orange-400 text-white border-0 shadow-lg shadow-orange-500/20 gap-3" data-testid="button-footer-cta">
                  Create a NextScene
                  <ArrowRight className="w-5 h-5" />
                </Button>
              </Link>
        ...
        <footer className="py-12 px-6 border-t border-white/10 bg-black">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <p className="text-white/30 text-sm">
              © 2025 NextScene. All rights reserved.
            </p>
          </div>
        </footer>
      </main>
