              ...
              {useCases.map((useCase, index) => (
                ...
                >
                  <Link href={useCase.href}>
                    <div 
                      className="group p-8 rounded-2xl bg-gradient-to-b from-white/5 to-transparent border border-white/10 hover:border-violet-500/50 cursor-pointer transition-all duration-300 hover:bg-white/5 h-full"
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 text-violet-400 text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity">
              ...
              {differentiators.map((diff, index) => (
                ...
                >
                  <div className="w-10 h-10 rounded-lg bg-violet-500/20 flex items-center justify-center flex-shrink-0">
                    <diff.icon className="w-5 h-5 text-violet-400" />
                  </div>
