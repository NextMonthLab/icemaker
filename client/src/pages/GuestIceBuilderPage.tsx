      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl flex-1">
        ...
        {!preview ? (
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            {!isProfessionalMode && (
              <div className="bg-white/[0.03] border border-purple-500/30 rounded-lg p-3 sm:p-4">
              ...
              <div className="flex items-center justify-end gap-2">
                ...
                {exportStatus?.status === "completed" && exportStatus.outputUrl ? (
                  <a
                    ...
                    download
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm bg-purple-600 hover:bg-purple-700 text-white rounded-md transition-colors"
                  ...
                  <div className="flex items-center gap-2 px-3 py-1.5 bg-purple-500/20 border border-purple-500/40 rounded-md">
                ...
                <Sheet open={showBiblePanel} onOpenChange={setShowBiblePanel}>
                  <SheetTrigger asChild>
                    ...
                    >
                      ...
                      Project Bible
                      {projectBible && (
                        <span className="ml-1 bg-purple-500/30 text-purple-200 px-1.5 rounded text-xs">v{projectBible.version}</span>
                      )}
                    </Button>
                  </SheetTrigger>
